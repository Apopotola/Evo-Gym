...
const classes: Array<ClassType> = [
  {
    ...
    description:
      "In a strength training class, you'll be moving heavy objects, or your body, in a way that creates resistance. “We use resistance to build strength, tone muscle, shed fat, burn calories—all packed into one workout.",
    image: image1,
  },
  {
    name: "Yoga Classes",
  ...
  },
  {
    ...
    description:
      "This may include activities such as mountaineering, trekking, bungee jumping, mountain biking, cycling, canoeing, scuba diving, rafting, kayaking, zip-lining, paragliding, hiking, exploring, canyoneering, sandboarding, caving and rock climbing..",
    image: image4,
  },
  {
